let bookSeries = [
  {
    seriesName: "Michael Vey",
    author: "Richard Paul Evans",
    numBooks: 7,
    websiteLink: "http://www.michaelvey.com/",
    bookImage: "MichaelVey.jpg",
    description: "A group of teenagers with unique abilities go up against a powerful group, known as the Elgen, who are trying to control the world's electricity.",
    books: [
      {
        likes: 0,
        dislikes: 0,
  ...
  },
  {
    ...
    author: "Rick Riordan",
    numBooks: 5,
    websiteLink: "https://rickriordan.com/series/percy-jackson-and-the-olympians/",
    bookImage: "PercyJackson.jpeg",
    description: "A group of empowered demi-gods work to stop the rise of the evil titan lord, Kronos.",
    books: [
      {
        likes: 0,
        dislikes: 0,
  ...
  },
  {
    ...
    numBooks: 13,
    websiteLink: "https://www.lemonysnicket.com/",
    bookImage: "SoUE.jpg",
    description: "The three Boudelaire orphans are pursued relentlessly by the evil Count Olaf trying to obtain the enormous fortune their parents left behind. In the process, the unlucky orphans must make several moral decisions and learn the difference between right and wrong.",
    books: [
      {
        likes: 0,
        dislikes: 0, 
  ...
  },
  {
    ...
    author: "Sarah J. Maas",
    numBooks: 7,
    websiteLink: "https://sarahjmaas.com/books/throne-of-glass-series/",
    bookImage: "ThroneOfGlass.jpg",
    description: "A young assassin is recruited to participate in a competition to become the king's champion. Throughout her journey, she will go through much pain and sorrow but grow to become the person she was always meant to be.",
    books: [
      {
        likes: 0,
        dislikes: 0,
